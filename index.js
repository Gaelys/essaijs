...
class LinkedSelected {
  ...
  constructor ($select) {
    ...
    // se déclenche quand choix d'un select (récupère puis injecte)
    onChange (e) {
        if (e.target.value === '0') {
          return
        }
...
let $selects = document.querySelectorAll('.linked-selected')
$selects.forEach(function ($select) {
    new LinkedSelected($select)
})